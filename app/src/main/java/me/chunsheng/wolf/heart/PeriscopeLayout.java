package me.chunsheng.wolf.heart;

/**
 * Created by wei_spring on 16/6/18.
 */
...
public class PeriscopeLayout extends RelativeLayout {
    ...
    private void init() {
        ...
        Drawable heart0 = getResources().getDrawable(R.drawable.heart0);
        ...
        dHeight = heart0.getIntrinsicHeight();
        dWidth = heart0.getIntrinsicWidth();
